...
![Version: 0.45.3](https://img.shields.io/badge/Version-0.45.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| authn.spiffe.workloadSocket | string | `"unix:///run/spire/sockets/spiffe-workload-api.sock"` |  |
