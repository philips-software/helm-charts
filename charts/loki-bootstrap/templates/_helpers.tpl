...
*/}}
{{- define "loki-bootstrap.fullname" -}}
...
Common labels
*/}}
{{- define "loki-bootstrap.labels" -}}
helm.sh/chart: {{ include "loki-bootstrap.chart" . }}
{{ include "loki-bootstrap.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "loki-bootstrap.selectorLabels" -}}
app.kubernetes.io/name: {{ include "loki-bootstrap.name" . }}
...
Usage: include "loki-bootstrap.substituteVars" dict "str" .Values.myValue "ctx" .
*/}}
{{- define "loki-bootstrap.substituteVars" -}}
{{- $str := .str }}
{{- $ctx := .ctx }}
...
*/}}
{{- define "loki-bootstrap.validateConfig" -}}
...
{{- end }}
{{- if not .Values.lokiChart.version }}
{{- fail "lokiChart.version is required and cannot be empty" }}
{{- end }}
{{- end }}
